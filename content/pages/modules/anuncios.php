<div class="col-sm-6 col-md-4 col-lg-2 col-xl-2 mt-2">
            ...
            <img src="https://ireland.apollo.olxcdn.com/v1/files/eyJmbiI6InJ5OG1jZHRhbjB5cDMtU1REVlRMUFQiLCJ3IjpbeyJmbiI6IjZtZ2p3bHA3a2dkYjItU1REVlRMUFQiLCJzIjoiMTYiLCJwIjoiMTAsLTEwIiwiYSI6IjAifV19.wedPwuMoZ_8sE9TkaI95uln2D8K1YzCdVC7b2g0xR0k/image;s=320x240" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Mercedes-Benz GLC 250 D 4-Matic </h5>
                    <p class="card-text">2018 . 95.977 kms . Diesel . Março . 204 cv </p>
                    <h5 class="card-title2 text-danger">48 900€</h5>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-md-4 col-lg-2 col-xl-2 mt-2">
        <div class="card">
            ...
            <div class="card-body">
                <h5 class="card-title">Volvo XC 90 2.0 D4 Inscription</h5>
                <p class="card-text">2016 . 110.915 kms . Diesel . Janeiro . 190 cv </p>
                <h5 class="card-title2 text-danger">48 900€</h5>
            </div>
        </div>
        </div>
        <div class="col-sm-6 col-md-4 col-lg-2 col-xl-2 mt-2">
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">Renault Mégane Sport Tourer 1.6 E-Tec</h5>
                    <p class="card-text">2020 . 35.998 kms . Híbrido(Gasolina) . Setembro . 160 cv </p>
                    <h5 class="card-title2 text-danger">31 990€</h5>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-md-4 col-lg-2 col-xl-2 mt-2">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">2018 . 135.000 kms . Elétrico . Junho . 184 cv </p>
                    <h5 class="card-title2 text-danger">25 999€</h5>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-md-4 col-lg-2 col-xl-2 mt-2">
            ...
            <img src="https://ireland.apollo.olxcdn.com/v1/files/eyJmbiI6IjlxdDQ3YTVkc3NkZjItU1REVlRMUFQiLCJ3IjpbeyJmbiI6IjZtZ2p3bHA3a2dkYjItU1REVlRMUFQiLCJzIjoiMTYiLCJwIjoiMTAsLTEwIiwiYSI6IjAifV19.vLnQ0kTcM9IMhjPpKbdUf8iW1lAED3mxgYQYIapigU4/image;s=320x240" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Today Sunshine M1</h5>
                    <p class="card-text">2021 . 2.003 kms . Elétrico . Fevereiro . 9 cv </p>
                    <h5 class="card-title2 text-danger">10 999€</h5>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-md-4 col-lg-2 col-xl-2 mt-2">
            ...
            <img src="https://ireland.apollo.olxcdn.com/v1/files/eyJmbiI6Imo4ZXQxbHFiOXZhNi1TVERWVExQVCIsInciOlt7ImZuIjoiNm1nandscDdrZ2RiMi1TVERWVExQVCIsInMiOiIxNiIsInAiOiIxMCwtMTAiLCJhIjoiMCJ9XX0.OIye3MYAv_NX_1n5Ykfy5N5gwO7LanwPD0cC7lBzgo0/image;s=320x240" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">BMW X1 16 d sDrive Advantage</h5>
                    <p class="card-text">2018 . 117.000 kms . Diesel . Fevereiro . 116 cv </p>
                    <h5 class="card-title2 text-danger">25 300€</h5>
                </div>
            </div>
        </div>